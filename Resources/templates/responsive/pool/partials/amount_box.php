    ...
    <form class="form-inline" role="form" method="GET" action="<?= $this->form_action ?>">
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input id="reward-pool" type="number" min="0" max="199" class="form-control input-lg input-amount" name="amount" value="<?= $this->amount ? $this->amount : '0' ?>" id="amount" required>
            </div>
        </div>
